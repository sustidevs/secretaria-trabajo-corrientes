...
*/
    /**
        Formulario Asesoramiento Juridico
     */
    ...
    public function storeTurnos(StoreFormularioRequest $request)
    {
        ...
        return Inertia::render($request->posee_abogado ? 'Formulario' : 'FormularioAJuridico',
            [
